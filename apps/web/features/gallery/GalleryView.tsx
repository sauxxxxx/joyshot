...
export function GalleryView() {
  ...
  return <section className={styles.gallery} aria-labelledby="gallery-title">
    ...
    {items.length === 0 ? <div className={styles.empty}><Images size={40} /><h2>Your first strip starts here.</h2><p>Finish a booth and choose “Save to gallery.” It stays privately on this device.</p><Link className="button buttonShutter" href="/solo">Take some photos <ArrowRight size={18} /></Link></div>
